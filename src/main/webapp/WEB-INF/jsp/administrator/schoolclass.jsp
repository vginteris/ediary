    ...
    <div class="container">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="/" id="saveteacher">
        ...
        <table id="myTable" class="table table-striped table-inverse">
            ...
            <c:forEach var="schoolclass" items="${classlist}">
                <tr id="row_schoolclass${schoolclass.getSchoolClassid()}">
                    <td id="id_row_schoolclass${schoolclass.getSchoolClassid()}"><c:out
                            value="${schoolclass.getSchoolClassid()}"/></td>
                    <td id="name_row_schoolclass${schoolclass.getSchoolClassid()}" contenteditable="true"><c:out
                            value="${schoolclass.getClassName()}"/></td>
                    <td>
                    <c:forEach var="apprentice" items="${schoolclass.apprenticeList}">
